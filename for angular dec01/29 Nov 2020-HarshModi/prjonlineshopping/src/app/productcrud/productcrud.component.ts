...
export class ProductcrudComponent implements OnInit {
  ...
  GetProducts() {
    ...
    ,
    (error) => {   
      console.error('Error caught in GetProduct of ProductCrud Component')
  ...
  // ,
  //   (error) => {   
  //     console.error('Error caught in DeleteProduct of ProductCrud Component')
  //     this.errorMessage = error;
  //    // this.loading = false;
  ...
  GetProductById(id) {
    ...
    (error) => {   
      console.error('Error caught in GetProductByid method of ProductCrud Component')
      this.errorMessage = error;
     // this.loading = false;
