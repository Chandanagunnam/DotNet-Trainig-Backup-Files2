...
export class RetailerviewComponent implements OnInit {
  ...
  GetRetailer() {
    ...
    (error) => {   
      console.error('Error caught in GetRetailer of retailerview Component')
  ...
  GetRetailerById(id) {
    ...
    (error) => {   
      console.error('Error caught in GetRetailerById of Retailerview Component')
      this.errorMessage = error;
     // this.loading = false;
  ...
  DeleteProduct() {
    ...
    ,
    (error) => {   
      console.error('Error caught in DeleteProduct of retailerview Component')
      this.errorMessage = error;
     // this.loading = false;
